    ...
    return (React__default['default'].createElement(StyledFooter, __assign({ p: ["40px 16px", null, "56px 40px 32px 40px"] }, props, { justifyContent: "center" }),
        React__default['default'].createElement(Flex, { flexDirection: "column", width: ["100%", null, "1200px;"] },
            React__default['default'].createElement(StyledIconMobileContainer, { display: ["block", null, "none"] },
                React__default['default'].createElement(Icon$1n, { width: "163px" })),
...
var PinePrice = function (_a) {
    ...
    return pinePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://alpinedex.finance/swap?outputCurrency=0xec5b9074717e467be06e96091f3d47c6e7871a95", target: "_blank" },
        ...
        React__default['default'].createElement(Text, { color: "textSubtle", bold: true }, "$" + pinePriceUsd.toFixed(7)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 }));
};
var PinePrice$1 = React__default['default'].memo(PinePrice);
var templateObject_1$b;

var MailLink = styled__default['default'].a(templateObject_1$a || (templateObject_1$a = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  svg {\n    transition: transform 0.3s;\n  }\n  :hover {\n    svg {\n      transform: scale(1.2);\n    }\n  }\n"])));
var Mail = function () {
    return (React__default['default'].createElement(MailLink, { href: "https://alpinecoin.org/adex-mail.html", target: "_blank" },
        React__default['default'].createElement(Icon$1k, { width: "24px" })));
};
var Mail$1 = React__default['default'].memo(Mail);
...
var PanelFooter = function (_a) {
    ...
    return (React__default['default'].createElement(Container, null,
        ...
        React__default['default'].createElement(SettingsEntry, null,
            ...
            React__default['default'].createElement(Mail$1, null))));
};
